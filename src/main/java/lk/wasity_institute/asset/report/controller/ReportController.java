...
//    School school = schoolService.findById(twoDate.getId());
  ...
  private void attendanceCommon(List< TimeTableStudentAttendance > timeTableStudentAttendances, List< BatchStudentAttendance > batchStudentAttendances, Batch batchDb) {
